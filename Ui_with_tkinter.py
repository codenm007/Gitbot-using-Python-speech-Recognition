...
def getHelp():
    ...
    label0 = Label(root2, text="what is your name    --->    Tells you the name")
    label1 = Label(root2, text="What's time    --->    Tells you the time")
    label2 = Label(root2, text="status     --->    git status")
    label3 = Label(root2, text="Add to cloud    --->    git push to your repo")
    label4 = Label(root2, text="commit my code    --->    git commit")
    label5 = Label(root2, text="backup my code    --->    git add .")
    label6 = Label(root2, text="Tell me about yourself    --->    Tells you what it can do!")
    label0.pack()
    label1.pack()
    label2.pack()
    label3.pack()
